...
const FriendRequestSidebarOption: FC<FriendRequestSidebarOptionProps> = ({initialRequestCount,sessionId}:FriendRequestSidebarOptionProps) => {
  ...
  return(
    <Link
      ...
      className='text-gray-700 duration-300 hover:text-indigo-600 hover:bg-gray-50 group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'>
